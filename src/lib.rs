...
pub mod chars {
    ...
    #[allow(non_camel_case_types)]
    pub type TCOD_char_t = u8;

    pub const TCOD_CHAR_HLINE: TCOD_char_t = ffi::TCOD_CHAR_HLINE as u8;
    pub const TCOD_CHAR_VLINE: TCOD_char_t = ffi::TCOD_CHAR_VLINE as u8;
    pub const TCOD_CHAR_NE: TCOD_char_t = ffi::TCOD_CHAR_NE as u8;
    pub const TCOD_CHAR_NW: TCOD_char_t = ffi::TCOD_CHAR_NW as u8;
    pub const TCOD_CHAR_SE: TCOD_char_t = ffi::TCOD_CHAR_SE as u8;
    pub const TCOD_CHAR_SW: TCOD_char_t = ffi::TCOD_CHAR_SW as u8;
    pub const TCOD_CHAR_TEEW: TCOD_char_t = ffi::TCOD_CHAR_TEEW as u8;
    pub const TCOD_CHAR_TEEE: TCOD_char_t = ffi::TCOD_CHAR_TEEE as u8;
    pub const TCOD_CHAR_TEEN: TCOD_char_t = ffi::TCOD_CHAR_TEEN as u8;
    pub const TCOD_CHAR_TEES: TCOD_char_t = ffi::TCOD_CHAR_TEES as u8;
    pub const TCOD_CHAR_CROSS: TCOD_char_t = ffi::TCOD_CHAR_CROSS as u8;
    pub const TCOD_CHAR_DHLINE: TCOD_char_t = ffi::TCOD_CHAR_DHLINE as u8;
    pub const TCOD_CHAR_DVLINE: TCOD_char_t = ffi::TCOD_CHAR_DVLINE as u8;
    pub const TCOD_CHAR_DNE: TCOD_char_t = ffi::TCOD_CHAR_DNE as u8;
    pub const TCOD_CHAR_DNW: TCOD_char_t = ffi::TCOD_CHAR_DNW as u8;
    pub const TCOD_CHAR_DSE: TCOD_char_t = ffi::TCOD_CHAR_DSE as u8;
    pub const TCOD_CHAR_DSW: TCOD_char_t = ffi::TCOD_CHAR_DSW as u8;
    pub const TCOD_CHAR_DTEEW: TCOD_char_t = ffi::TCOD_CHAR_DTEEW as u8;
    pub const TCOD_CHAR_DTEEE: TCOD_char_t = ffi::TCOD_CHAR_DTEEE as u8;
    pub const TCOD_CHAR_DTEEN: TCOD_char_t = ffi::TCOD_CHAR_DTEEN as u8;
    pub const TCOD_CHAR_DTEES: TCOD_char_t = ffi::TCOD_CHAR_DTEES as u8;
    pub const TCOD_CHAR_DCROSS: TCOD_char_t = ffi::TCOD_CHAR_DCROSS as u8;
    pub const TCOD_CHAR_BLOCK1: TCOD_char_t = ffi::TCOD_CHAR_BLOCK1 as u8;
    pub const TCOD_CHAR_BLOCK2: TCOD_char_t = ffi::TCOD_CHAR_BLOCK2 as u8;
    pub const TCOD_CHAR_BLOCK3: TCOD_char_t = ffi::TCOD_CHAR_BLOCK3 as u8;
    pub const TCOD_CHAR_ARROW_N: TCOD_char_t = ffi::TCOD_CHAR_ARROW_N as u8;
    pub const TCOD_CHAR_ARROW_S: TCOD_char_t = ffi::TCOD_CHAR_ARROW_S as u8;
    pub const TCOD_CHAR_ARROW_E: TCOD_char_t = ffi::TCOD_CHAR_ARROW_E as u8;
    pub const TCOD_CHAR_ARROW_W: TCOD_char_t = ffi::TCOD_CHAR_ARROW_W as u8;
    pub const TCOD_CHAR_ARROW2_N: TCOD_char_t = ffi::TCOD_CHAR_ARROW2_N as u8;
    pub const TCOD_CHAR_ARROW2_S: TCOD_char_t = ffi::TCOD_CHAR_ARROW2_S as u8;
    pub const TCOD_CHAR_ARROW2_E: TCOD_char_t = ffi::TCOD_CHAR_ARROW2_E as u8;
    pub const TCOD_CHAR_ARROW2_W: TCOD_char_t = ffi::TCOD_CHAR_ARROW2_W as u8;
    pub const TCOD_CHAR_DARROW_H: TCOD_char_t = ffi::TCOD_CHAR_DARROW_H as u8;
    pub const TCOD_CHAR_DARROW_V: TCOD_char_t = ffi::TCOD_CHAR_DARROW_V as u8;
    pub const TCOD_CHAR_CHECKBOX_UNSET: TCOD_char_t = ffi::TCOD_CHAR_CHECKBOX_UNSET as u8;
    pub const TCOD_CHAR_CHECKBOX_SET: TCOD_char_t = ffi::TCOD_CHAR_CHECKBOX_SET as u8;
    pub const TCOD_CHAR_RADIO_UNSET: TCOD_char_t = ffi::TCOD_CHAR_RADIO_UNSET as u8;
    pub const TCOD_CHAR_RADIO_SET: TCOD_char_t = ffi::TCOD_CHAR_RADIO_SET as u8;
    pub const TCOD_CHAR_SUBP_NW: TCOD_char_t = ffi::TCOD_CHAR_SUBP_NW as u8;
    pub const TCOD_CHAR_SUBP_NE: TCOD_char_t = ffi::TCOD_CHAR_SUBP_NE as u8;
    pub const TCOD_CHAR_SUBP_N: TCOD_char_t = ffi::TCOD_CHAR_SUBP_N as u8;
    pub const TCOD_CHAR_SUBP_SE: TCOD_char_t = ffi::TCOD_CHAR_SUBP_SE as u8;
    pub const TCOD_CHAR_SUBP_DIAG: TCOD_char_t = ffi::TCOD_CHAR_SUBP_DIAG as u8;
    pub const TCOD_CHAR_SUBP_E: TCOD_char_t = ffi::TCOD_CHAR_SUBP_E as u8;
    pub const TCOD_CHAR_SUBP_SW: TCOD_char_t = ffi::TCOD_CHAR_SUBP_SW as u8;
    pub const TCOD_CHAR_SMILIE: TCOD_char_t = ffi::TCOD_CHAR_SMILIE as u8;
    pub const TCOD_CHAR_SMILIE_INV: TCOD_char_t = ffi::TCOD_CHAR_SMILIE_INV as u8;
    pub const TCOD_CHAR_HEART: TCOD_char_t = ffi::TCOD_CHAR_HEART as u8;
    pub const TCOD_CHAR_DIAMOND: TCOD_char_t = ffi::TCOD_CHAR_DIAMOND as u8;
    pub const TCOD_CHAR_CLUB: TCOD_char_t = ffi::TCOD_CHAR_CLUB as u8;
    pub const TCOD_CHAR_SPADE: TCOD_char_t = ffi::TCOD_CHAR_SPADE as u8;
    pub const TCOD_CHAR_BULLET: TCOD_char_t = ffi::TCOD_CHAR_BULLET as u8;
    pub const TCOD_CHAR_BULLET_INV: TCOD_char_t = ffi::TCOD_CHAR_BULLET_INV as u8;
    pub const TCOD_CHAR_MALE: TCOD_char_t = ffi::TCOD_CHAR_MALE as u8;
    pub const TCOD_CHAR_FEMALE: TCOD_char_t = ffi::TCOD_CHAR_FEMALE as u8;
    pub const TCOD_CHAR_NOTE: TCOD_char_t = ffi::TCOD_CHAR_NOTE as u8;
    pub const TCOD_CHAR_NOTE_DOUBLE: TCOD_char_t = ffi::TCOD_CHAR_NOTE_DOUBLE as u8;
    pub const TCOD_CHAR_LIGHT: TCOD_char_t = ffi::TCOD_CHAR_LIGHT as u8;
    pub const TCOD_CHAR_EXCLAM_DOUBLE: TCOD_char_t = ffi::TCOD_CHAR_EXCLAM_DOUBLE as u8;
    pub const TCOD_CHAR_PILCROW: TCOD_char_t = ffi::TCOD_CHAR_PILCROW as u8;
    pub const TCOD_CHAR_SECTION: TCOD_char_t = ffi::TCOD_CHAR_SECTION as u8;
    pub const TCOD_CHAR_POUND: TCOD_char_t = ffi::TCOD_CHAR_POUND as u8;
    pub const TCOD_CHAR_MULTIPLICATION: TCOD_char_t = ffi::TCOD_CHAR_MULTIPLICATION as u8;
    pub const TCOD_CHAR_FUNCTION: TCOD_char_t = ffi::TCOD_CHAR_FUNCTION as u8;
    pub const TCOD_CHAR_RESERVED: TCOD_char_t = ffi::TCOD_CHAR_RESERVED as u8;
    pub const TCOD_CHAR_HALF: TCOD_char_t = ffi::TCOD_CHAR_HALF as u8;
    pub const TCOD_CHAR_ONE_QUARTER: TCOD_char_t = ffi::TCOD_CHAR_ONE_QUARTER as u8;
    pub const TCOD_CHAR_COPYRIGHT: TCOD_char_t = ffi::TCOD_CHAR_COPYRIGHT as u8;
    pub const TCOD_CHAR_CENT: TCOD_char_t = ffi::TCOD_CHAR_CENT as u8;
    pub const TCOD_CHAR_YEN: TCOD_char_t = ffi::TCOD_CHAR_YEN as u8;
    pub const TCOD_CHAR_CURRENCY: TCOD_char_t = ffi::TCOD_CHAR_CURRENCY as u8;
    pub const TCOD_CHAR_THREE_QUARTERS: TCOD_char_t = ffi::TCOD_CHAR_THREE_QUARTERS as u8;
    pub const TCOD_CHAR_DIVISION: TCOD_char_t = ffi::TCOD_CHAR_DIVISION as u8;
    pub const TCOD_CHAR_GRADE: TCOD_char_t = ffi::TCOD_CHAR_GRADE as u8;
    pub const TCOD_CHAR_UMLAUT: TCOD_char_t = ffi::TCOD_CHAR_UMLAUT as u8;
    pub const TCOD_CHAR_POW1: TCOD_char_t = ffi::TCOD_CHAR_POW1 as u8;
    pub const TCOD_CHAR_POW3: TCOD_char_t = ffi::TCOD_CHAR_POW3 as u8;
    pub const TCOD_CHAR_POW2: TCOD_char_t = ffi::TCOD_CHAR_POW2 as u8;
    pub const TCOD_CHAR_BULLET_SQUARE: TCOD_char_t = ffi::TCOD_CHAR_BULLET_SQUARE as u8;
}
