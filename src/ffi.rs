...
pub type Struct__IO_FILE = ::libc::c_void;
...
pub type Struct_tm = ::libc::c_void;
...
pub type Struct___locale_data = ::libc::c_void;
...
pub struct TCOD_lex_t {
    ...
    pub simpleCmt: *::libc::c_char,
    pub cmtStart: *::libc::c_char,
    pub cmtStop: *::libc::c_char,
    pub javadocCmtStart: *::libc::c_char,
    pub stringDelim: *::libc::c_char,
...
pub struct TCOD_parser_listener_t {
    pub new_struct: ::std::option::Option<extern "C" fn
                                              (arg1: TCOD_parser_struct_t,
                                               arg2: *::libc::c_char)
                                              -> _bool>,
    pub new_flag: ::std::option::Option<extern "C" fn(arg1: *::libc::c_char)
                                            -> _bool>,
    ...
    pub end_struct: ::std::option::Option<extern "C" fn
                                              (arg1: TCOD_parser_struct_t,
                                               arg2: *::libc::c_char)
                                              -> _bool>,
    pub error: ::std::option::Option<extern "C" fn(arg1: *::libc::c_char)>,
}
...
extern "C" {
     ...
     *mut wchar_t;
    pub fn wcscmp(__s1: *wchar_t, __s2: *wchar_t) -> ::libc::c_int;
    pub fn wcsncmp(__s1: *wchar_t, __s2: *wchar_t, __n: size_t) ->
     ::libc::c_int;
    pub fn wcscasecmp(__s1: *wchar_t, __s2: *wchar_t) -> ::libc::c_int;
    pub fn wcsncasecmp(__s1: *wchar_t, __s2: *wchar_t, __n: size_t) ->
     ::libc::c_int;
    ...
    pub fn wcscoll(__s1: *wchar_t, __s2: *wchar_t) -> ::libc::c_int;
    ...
    pub fn wmemcmp(__s1: *wchar_t, __s2: *wchar_t, __n: size_t) ->
     ::libc::c_int;
    ...
    pub fn mbsinit(__ps: *mbstate_t) -> ::libc::c_int;
    pub fn mbrtowc(__pwc: *mut wchar_t, __s: *::libc::c_char, __n: size_t,
                   __p: *mut mbstate_t) -> size_t;
    pub fn wcrtomb(__s: *mut ::libc::c_char, __wc: wchar_t,
                   __ps: *mut mbstate_t) -> size_t;
    pub fn __mbrlen(__s: *::libc::c_char, __n: size_t, __ps: *mut mbstate_t)
     -> size_t;
    pub fn mbrlen(__s: *::libc::c_char, __n: size_t, __ps: *mut mbstate_t) ->
     size_t;
    pub fn mbsrtowcs(__dst: *mut wchar_t, __src: *mut *::libc::c_char,
                     __len: size_t, __ps: *mut mbstate_t) -> size_t;
    pub fn wcsrtombs(__dst: *mut ::libc::c_char, __src: *mut *wchar_t,
                     __len: size_t, __ps: *mut mbstate_t) -> size_t;
    pub fn mbsnrtowcs(__dst: *mut wchar_t, __src: *mut *::libc::c_char,
                      __nmc: size_t, __len: size_t, __ps: *mut mbstate_t) ->
     size_t;
    pub fn wcsnrtombs(__dst: *mut ::libc::c_char, __src: *mut *wchar_t,
                      __nwc: size_t, __len: size_t, __ps: *mut mbstate_t) ->
     size_t;
    pub fn wcstod(__nptr: *wchar_t, __endptr: *mut *mut wchar_t) ->
     ::libc::c_double;
    pub fn wcstof(__nptr: *wchar_t, __endptr: *mut *mut wchar_t) ->
     ::libc::c_float;
    pub fn wcstold(__nptr: *wchar_t, __endptr: *mut *mut wchar_t) ->
     ::libc::c_double;
    ...
    pub fn fwprintf(__stream: *mut __FILE, __format: *wchar_t, ...) ->
     ::libc::c_int;
    pub fn wprintf(__format: *wchar_t, ...) -> ::libc::c_int;
    ...
    pub fn vwprintf(__format: *wchar_t, __arg: __gnuc_va_list) ->
     ::libc::c_int;
    pub fn vswprintf(__s: *mut wchar_t, __n: size_t, __format: *wchar_t,
                     __arg: __gnuc_va_list) -> ::libc::c_int;
    pub fn fwscanf(__stream: *mut __FILE, __format: *wchar_t, ...) ->
     ::libc::c_int;
    pub fn wscanf(__format: *wchar_t, ...) -> ::libc::c_int;
    pub fn swscanf(__s: *wchar_t, __format: *wchar_t, ...) -> ::libc::c_int;
    pub fn vfwscanf(__s: *mut __FILE, __format: *wchar_t,
                    __arg: __gnuc_va_list) -> ::libc::c_int;
    pub fn vwscanf(__format: *wchar_t, __arg: __gnuc_va_list) ->
     ::libc::c_int;
    ...
    pub fn fputws(__ws: *wchar_t, __stream: *mut __FILE) -> ::libc::c_int;
    pub fn ungetwc(__wc: wint_t, __stream: *mut __FILE) -> wint_t;
    pub fn wcsftime(__s: *mut wchar_t, __maxsize: size_t, __format: *wchar_t,
                    __tp: *Struct_tm) -> size_t;
    pub fn TCOD_strdup(s: *::libc::c_char) -> *mut ::libc::c_char;
    pub fn TCOD_strcasecmp(s1: *::libc::c_char, s2: *::libc::c_char) ->
     ::libc::c_int;
    pub fn TCOD_strncasecmp(s1: *::libc::c_char, s2: *::libc::c_char,
                            n: size_t) -> ::libc::c_int;
    ...
    pub fn TCOD_list_push(l: TCOD_list_t, elt: *::libc::c_void);
     ...
     *mut ::libc::c_void;
    pub fn TCOD_list_set(l: TCOD_list_t, elt: *::libc::c_void,
                         idx: ::libc::c_int);
     ...
     *mut *mut ::libc::c_void;
    pub fn TCOD_list_remove(l: TCOD_list_t, elt: *::libc::c_void);
    pub fn TCOD_list_remove_iterator_fast(l: TCOD_list_t,
                                          elt: *mut *mut ::libc::c_void) ->
     *mut *mut ::libc::c_void;
    pub fn TCOD_list_remove_fast(l: TCOD_list_t, elt: *::libc::c_void);
    pub fn TCOD_list_contains(l: TCOD_list_t, elt: *::libc::c_void) -> _bool;
    ...
    pub fn TCOD_list_insert_before(l: TCOD_list_t, elt: *::libc::c_void,
                                   before: ::libc::c_int) ->
     *mut *mut ::libc::c_void;
    ...
    pub fn TCOD_color_gen_map(map: *mut TCOD_color_t, nb_key: ::libc::c_int,
                              ...
                              key_index: *::libc::c_int);
    pub fn TCOD_console_init_root(w: ::libc::c_int, h: ::libc::c_int,
                                  title: *::libc::c_char, fullscreen: _bool,
                                  renderer: TCOD_renderer_t);
    pub fn TCOD_console_set_window_title(title: *::libc::c_char);
    ...
    pub fn TCOD_console_set_custom_font(fontFile: *::libc::c_char,
                                        flags: ::libc::c_int,
    ...
    pub fn TCOD_console_map_ascii_codes_to_font(asciiCode: ::libc::c_int,
                                                ...
                                                fontCharX: ::libc::c_int,
                                                fontCharY: ::libc::c_int);
    pub fn TCOD_console_map_string_to_font(s: *::libc::c_char,
                                           fontCharX: ::libc::c_int,
                                           fontCharY: ::libc::c_int);
    ...
    pub fn TCOD_console_print_frame(con: TCOD_console_t, x: ::libc::c_int,
                                    ...
                                    flag: TCOD_bkgnd_flag_t,
                                    fmt: *::libc::c_char, ...);
    pub fn TCOD_console_map_string_to_font_utf(s: *wchar_t,
                                               fontCharX: ::libc::c_int,
                                               fontCharY: ::libc::c_int);
    pub fn TCOD_console_print_utf(con: TCOD_console_t, x: ::libc::c_int,
                                  y: ::libc::c_int, fmt: *wchar_t, ...);
    ...
    pub fn TCOD_console_from_file(filename: *::libc::c_char) ->
     TCOD_console_t;
    pub fn TCOD_console_load_asc(con: TCOD_console_t,
                                 filename: *::libc::c_char) -> _bool;
    ...
    pub fn TCOD_image_load(filename: *::libc::c_char) -> TCOD_image_t;
    ...
    pub fn TCOD_image_scale(image: TCOD_image_t, neww: ::libc::c_int,
                            newh: ::libc::c_int);
    pub fn TCOD_image_save(image: TCOD_image_t, filename: *::libc::c_char);
    ...
    pub fn TCOD_sys_save_screenshot(filename: *::libc::c_char);
    ...
    pub fn TCOD_sys_create_directory(path: *::libc::c_char) -> _bool;
    pub fn TCOD_sys_delete_file(path: *::libc::c_char) -> _bool;
    pub fn TCOD_sys_delete_directory(path: *::libc::c_char) -> _bool;
    pub fn TCOD_sys_is_directory(path: *::libc::c_char) -> _bool;
    pub fn TCOD_sys_get_directory_content(path: *::libc::c_char,
                                          pattern: *::libc::c_char) ->
     TCOD_list_t;
    pub fn TCOD_sys_file_exists(filename: *::libc::c_char, ...) -> _bool;
    pub fn TCOD_sys_read_file(filename: *::libc::c_char,
                              buf: *mut *mut ::libc::c_uchar,
                              size: *mut uint32) -> _bool;
    pub fn TCOD_sys_write_file(filename: *::libc::c_char,
                               buf: *mut ::libc::c_uchar, size: uint32) ->
     _bool;
    pub fn TCOD_sys_clipboard_set(value: *::libc::c_char);
    ...
    pub fn TCOD_load_library(path: *::libc::c_char) -> TCOD_library_t;
    pub fn TCOD_get_function_address(library: TCOD_library_t,
                                     function_name: *::libc::c_char) ->
     *mut ::libc::c_void;
    ...
    pub fn TCOD_random_get_double_mean(mersenne: TCOD_random_t,
                                       ...
                                       mean: ::libc::c_double) ->
     ::libc::c_double;
    pub fn TCOD_random_dice_new(s: *::libc::c_char) -> TCOD_dice_t;
    ...
    pub fn TCOD_lex_new(symbols: *mut *::libc::c_char,
                        keywords: *mut *::libc::c_char,
                        simpleComment: *::libc::c_char,
                        commentStart: *::libc::c_char,
                        commentStop: *::libc::c_char,
                        javadocCommentStart: *::libc::c_char,
                        stringDelim: *::libc::c_char, flags: ::libc::c_int) ->
     *mut TCOD_lex_t;
    ...
    pub fn TCOD_struct_get_name(def: TCOD_parser_struct_t) -> *::libc::c_char;
    ...
    pub fn TCOD_heightmap_get_value(hm: *TCOD_heightmap_t, x: ::libc::c_int,
                                    y: ::libc::c_int) -> ::libc::c_float;
    ...
    pub fn TCOD_heightmap_set_value(hm: *mut TCOD_heightmap_t,
                                    x: ::libc::c_int, y: ::libc::c_int,
                                    value: ::libc::c_float);
    pub fn TCOD_heightmap_get_slope(hm: *TCOD_heightmap_t, x: ::libc::c_int,
                                    y: ::libc::c_int) -> ::libc::c_float;
    pub fn TCOD_heightmap_get_normal(hm: *TCOD_heightmap_t,
                                     x: ::libc::c_float, y: ::libc::c_float,
                                     n: [::libc::c_float, ..3u],
                                     waterLevel: ::libc::c_float);
    pub fn TCOD_heightmap_count_cells(hm: *TCOD_heightmap_t,
                                      min: ::libc::c_float,
                                      max: ::libc::c_float) -> ::libc::c_int;
    pub fn TCOD_heightmap_has_land_on_border(hm: *TCOD_heightmap_t,
                                             waterLevel: ::libc::c_float) ->
     _bool;
    pub fn TCOD_heightmap_get_minmax(hm: *TCOD_heightmap_t,
    ...
    pub fn TCOD_zip_put_string(zip: TCOD_zip_t, val: *::libc::c_char);
    ...
    pub fn TCOD_zip_save_to_file(zip: TCOD_zip_t, filename: *::libc::c_char)
     -> ::libc::c_int;
    pub fn TCOD_zip_load_from_file(zip: TCOD_zip_t, filename: *::libc::c_char)
     -> ::libc::c_int;
    ...
    pub fn TCOD_zip_get_string(zip: TCOD_zip_t) -> *::libc::c_char;
    ...
    pub fn TCOD_namegen_parse(filename: *::libc::c_char,
    ...
    pub fn TCOD_text_get(txt: TCOD_text_t) -> *::libc::c_char;
