...
pub enum Distribution {
    ...
    GaussianRangeInverse =
        ffi::TCOD_distribution_t::TCOD_DISTRIBUTION_GAUSSIAN_RANGE_INVERSE as u32,
}
...
impl Rng {
    pub fn get_instance() -> Rng {
        unsafe {
            Rng {
                tcod_random: ffi::TCOD_random_get_instance(),
                default: true,
            }
        }
    }
    ...
    pub fn new(algo: Algo) -> Rng {
        unsafe {
            Rng {
                tcod_random: ffi::TCOD_random_new(algo.into()),
                default: false,
            }
        }
    }
    ...
    pub fn new_with_seed(algo: Algo, seed: u32) -> Rng {
        unsafe {
            Rng {
                tcod_random: ffi::TCOD_random_new_from_seed(algo.into(), seed),
                default: false,
            }
        }
    }
    ...
    pub fn save(&self) -> Rng {
        unsafe {
            Rng {
                tcod_random: ffi::TCOD_random_save(self.tcod_random),
                default: false,
            }
        }
    }
    ...
    pub fn get_int(&self, min: i32, max: i32) -> i32 {
        unsafe { ffi::TCOD_random_get_int(self.tcod_random, min, max) }
    }

    pub fn get_int_mean(&self, min: i32, max: i32, mean: i32) -> i32 {
        unsafe { ffi::TCOD_random_get_int_mean(self.tcod_random, min, max, mean) }
    }

    pub fn get_float(&self, min: f32, max: f32) -> f32 {
        unsafe { ffi::TCOD_random_get_float(self.tcod_random, min, max) }
    }

    pub fn get_float_mean(&self, min: f32, max: f32, mean: f32) -> f32 {
        unsafe { ffi::TCOD_random_get_float_mean(self.tcod_random, min, max, mean) }
    }

    pub fn get_double(&self, min: f64, max: f64) -> f64 {
        unsafe { ffi::TCOD_random_get_double(self.tcod_random, min, max) }
    }

    pub fn get_double_mean(&self, min: f64, max: f64, mean: f64) -> f64 {
        unsafe { ffi::TCOD_random_get_double_mean(self.tcod_random, min, max, mean) }
    }
}
